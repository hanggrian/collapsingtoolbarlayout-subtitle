...
import io.github.hendraanggrian.subtitlecollapsingtoolbarlayout.internal.MathUtils;
...
// end modification
    ...
    // begin modification
    void setExpandedSubtitleTextColor(int mExpandedSubColor) {
...
// end
    ...
    void setCollapsedTitleTextColor(int textColor) {
    ...
    void setExpandedTitleTextColor(int textColor) {
