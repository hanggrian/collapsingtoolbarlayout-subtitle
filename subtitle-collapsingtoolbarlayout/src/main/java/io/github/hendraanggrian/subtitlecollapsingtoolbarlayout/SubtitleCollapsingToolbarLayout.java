...
package io.github.hendraanggrian.subtitlecollapsingtoolbarlayout;
...
import io.github.hendraanggrian.subtitlecollapsingtoolbarlayout.internal.AnimationUtils;
import io.github.hendraanggrian.subtitlecollapsingtoolbarlayout.internal.ThemeUtils;
import io.github.hendraanggrian.subtitlecollapsingtoolbarlayout.internal.ValueAnimatorCompat;
import io.github.hendraanggrian.subtitlecollapsingtoolbarlayout.internal.ViewGroupUtils;
import io.github.hendraanggrian.subtitlecollapsingtoolbarlayout.internal.ViewOffsetHelper;
import io.github.hendraanggrian.subtitlecollapsingtoolbarlayout.internal.ViewUtils;
 ...
 * on {@link Build.VERSION_CODES#LOLLIPOP LOLLIPOP} devices when we set to fit system
 * windows.
 * <p>
...
public class SubtitleCollapsingToolbarLayout extends FrameLayout {
    ...
    public SubtitleCollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (mStyle.hasValue(R.styleable.SubtitleCollapsingToolbarLayout_collapsedSubtitleAppearance)) {
            mCollapsingTextHelper.setCollapsedSubAppearance(
                    mStyle.getResourceId(R.styleable.SubtitleCollapsingToolbarLayout_collapsedSubtitleAppearance, 0)
            );
        }

        if (mStyle.hasValue(R.styleable.SubtitleCollapsingToolbarLayout_expandedSubtitleAppearance)) {
            mCollapsingTextHelper.setExpandedSubAppearance(
                    mStyle.getResourceId(R.styleable.SubtitleCollapsingToolbarLayout_expandedSubtitleAppearance, 0)
            );
        }
        // end
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
         ...
         * {@link SubtitleCollapsingToolbarLayout}.
         */
